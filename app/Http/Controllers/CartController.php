...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!Session::has('cart')) { //senao tiver uma sessao cart
            Session::set('cart', $this->cart); //crie uma sessao cart
        }

        return view('store.cart', ['cart' => Session::get('cart')]); //pega e passa o conteudo da sessao
    }
